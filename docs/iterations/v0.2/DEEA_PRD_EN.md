...
**Status:** Code merged into `main` via [PR #4](https://github.com/gwx4399-cell/coca-word-frequency-tool/pull/4); this document is proposed in a follow-up documentation PR.  
