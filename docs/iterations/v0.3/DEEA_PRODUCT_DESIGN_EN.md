...
**Status:** A drawing of the screens implemented on [PR #6](https://github.com/gwx4399-cell/coca-word-frequency-tool/pull/6), pending review and merge; no public deployment claim. **Date:** 2026-09-23.
